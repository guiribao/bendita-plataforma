      ...
      <Container fluid className='app-content'>
        ...
        <Card className='border-0 shadow-sm'>
          <Card.Body className='p-0'>
            <Tabs id='editar-tabs' activeKey={activeTab} onSelect={(k) => setActiveTab(k || 'pessoal')} className='mb-0'>
              {/* Abas de Informações Pessoais */}
              <Tab
                eventKey='pessoal'
                title={
                  <>
                    <i className='las la-user'></i> Pessoais
                  </>
                }
              >
                <div className='p-4'>
                    ...
                    <Row className='g-3 mb-3'>
                      <Col md={6}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='nome_completo' defaultValue={perfil.nome_completo} required />
                        </BSForm.Group>
                      </Col>
                      <Col md={6}>
                        <BSForm.Group>
                          <BSForm.Label>Apelido</BSForm.Label>
                          <BSForm.Control type='text' name='apelido' defaultValue={perfil.apelido || ''} />
                        </BSForm.Group>
                      </Col>
                      ...
                      <Col md={6}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='rg' defaultValue={perfil.rg || ''} />
                        </BSForm.Group>
                      </Col>
                      ...
                      <Col md={6}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='nacionalidade' defaultValue={perfil.nacionalidade || ''} />
                        </BSForm.Group>
                      </Col>
                    ...
                    <Row className='g-3 mb-3'>
                      ...
                      <Col md={9}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='endereco_rua' defaultValue={perfil.endereco_rua || ''} />
                        </BSForm.Group>
                      </Col>
                      ...
                      <Col md={3}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='endereco_numero' defaultValue={perfil.endereco_numero || ''} />
                        </BSForm.Group>
                      </Col>
                      ...
                      <Col md={4}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='endereco_bairro' defaultValue={perfil.endereco_bairro || ''} />
                        </BSForm.Group>
                      </Col>
                      ...
                      <Col md={5}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='endereco_cidade' defaultValue={perfil.endereco_cidade || ''} />
                        </BSForm.Group>
                      </Col>
                      ...
                      <Col md={3}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='endereco_estado' defaultValue={perfil.endereco_estado || ''} placeholder='SP' maxLength={2} />
                        </BSForm.Group>
                      </Col>
                    </Row>
                    ...
                    <Row className='g-3 mb-3'>
                      <Col md={6}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='redes_instagram' defaultValue={perfil.redes_instagram || ''} placeholder='seu_usuario' />
                      ...
                      <Col md={6}>
                        <BSForm.Group>
                          ...
                          <BSForm.Control type='text' name='redes_linkedin' defaultValue={perfil.redes_linkedin || ''} placeholder='seu-nome-completo' />
              ...
              {perfil.Associacao && (
                <Tab
                  ...
                  title={
                    <>
                      <i className='las la-heartbeat'></i> Saúde
                    </>
                  }
                >
                  <div className='p-4'>
                      ...
                      <Row className='g-3 mb-3'>
                        ...
                        <Col md={12}>
                          <BSForm.Group>
                            ...
                            <BSForm.Control type='text' name='saude_uso_medicacao_nome' defaultValue={perfil.Associacao.saude_uso_medicacao_nome || ''} />
                          </BSForm.Group>
                        </Col>
                        ...
                        <Col md={6}>
                          <BSForm.Group>
                            ...
                            <BSForm.Control type='text' name='saude_medico_prescritor_crm' defaultValue={perfil.Associacao.saude_medico_prescritor_crm || ''} />
                          </BSForm.Group>
                        </Col>
                      </Row>
