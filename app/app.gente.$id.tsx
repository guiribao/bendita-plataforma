    ...
    <LayoutRestrictArea usuarioSistema={usuario}>
      <Container fluid className='app-content'>
        ...
        <Row className='align-items-center mt-3 mb-4'>
          <Col>
            <h2 className='mb-0'>Detalhes do Perfil</h2>
          </Col>
          <Col xs='auto' className='d-flex gap-2'>
            ...
            >
              <i className='las la-arrow-left me-1' /> Voltar
            </Button>
            <Button 
              variant='outline-primary'
              onClick={() => navigate(`/app/gente/${perfil.id}/editar`)}
            >
              <i className='las la-pen me-1' /> Editar
            </Button>
          </Col>
        </Row>
                    ...
                    <ListGroup variant='flush'>
                      <ListGroup.Item className='px-0'>
                        <Row className='align-items-center'>
                          ...
                          <Col xs={8}>
                            <Badge bg='info'>{perfil.Associacao.tipo_associado}</Badge>
                          </Col>
                        </Row>
                      </ListGroup.Item>
                      <ListGroup.Item className='px-0'>
                        <Row className='align-items-center'>
                          ...
                          <Col xs={8}>
                            <Badge bg='warning'>{perfil.Associacao.status}</Badge>
                          </Col>
                        </Row>
                      </ListGroup.Item>
